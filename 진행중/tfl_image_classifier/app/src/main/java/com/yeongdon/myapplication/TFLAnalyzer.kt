...
class ImageClassifierHelper(
    ...
    private fun setupImageClassifier() {
        ...
        val modelName =
            when (currentModel) {
                MODEL_DR-> "mobilenetv1.tflite"
                MODEL_FP16 -> "efficientnet-lite0.tflite"
                MODEL_INT8 -> "efficientnet-lite1.tflite"
    ...
    companion object {
        ...
        const val MODEL_DR= 0
        const val MODEL_FP16 = 1
        const val MODEL_INT8 = 2
